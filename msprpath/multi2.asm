...
sprorder        = $40           ;Order table need to be on zeropage due to addressing modes
...
screen1         = $0400
        ...
        ; Sprite data
                ...
                *=$0fc0
                ...
                .fill 64,255     ;The sprite frame we are using ($3f)
...
move_proc:
                ldx movement_phase
                inx
                stx movement_phase              ;store x
                ldy #NUMSPR-1
moveloop:
                lda data_x,x
                sta sprxl,y
                lda sprxh,y                     ;Update X coordinate high byte, wrap when coordinate
                lda data_x_hi,x
                sta sprxh,y
                lda data_y,x
                sta spry,y
...
sprirqadvancetbl:
                .char -4,-5,-6,-7,-7,-8,-9,-10   ;$d012 advance for raster IRQs based on number of sprites in the same IRQ
...
sprortbl:       .byte $01,$02,$04,$08,$10,$20,$40,$80 ;Or table for $d010 manipulation, repeated for 2x max sprites (doublebuffer)
...
sprirqjumptblhi:.byte >irq2_spr0
                ...
                .byte >irq2_spr7
.align 256
data_x .binary "data/x_lo.dat"
data_x_hi .fill 256,0
data_y .binary "data/y_lo.dat"
